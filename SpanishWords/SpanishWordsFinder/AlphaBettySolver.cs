...
namespace SpanishWordsFinder
{
    class AlphaBettySolver
    {
        private HashSet<string> foundWords;
        private HashSet<string> foundWordsSquares;
        ...
        {
            string results = "";
            foreach (string square in foundWordsSquares)
                results += square + "|";
            if (!results.Equals(""))
        ...
        public void Solve()
        {
            ...
            this.foundWordsSquares = new HashSet<string>();
            ...
            //Console.WriteLine(spanishWords.Contains("aabam"));
        }
        ...
        public void FindWords(string currentWord, int line, int col, string[,] letters, HashSet<string> analysedSquares)
        {
            ...
            if (existsWord == 1)
            {
                ...
                foreach (string square in analysedSquares)
                    foundWordsSquares.Add(square);
                foundWordsSquares.Add(GetSquareId(line, col));
            }
            if (existsWord > -1)
            {
